...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToTraveler.Auth.Model.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ToTraveler.Models.Session", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ToTraveler.Auth.Model.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ToTraveler.Models.Review", b =>
                {
                    b.HasOne("ToTraveler.Models.Location", null)
                        .WithMany("Reviews")
            ...
            modelBuilder.Entity("ToTraveler.Models.Session", b =>
                {
                    b.HasOne("ToTraveler.Auth.Model.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
